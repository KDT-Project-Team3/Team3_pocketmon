...
public class PokeDex {
    ...
    private static Map<String, String> evolveDict = new HashMap<>();
    ...
    static {
        ...
        EvolvedPokemon pixie = new EvolvedPokemon("픽시", 50, 22);
        EvolvedPokemon wigglytuff = new EvolvedPokemon("푸크린", 60, 25);
        ...
        // 진화 트리 추가
        evolveDict.put("삐삐", "픽시");
        evolveDict.put("푸린", "푸크린");
    }
    ...
    public static String getEvolvePokemon(String name) {
        return evolveDict.get(name);
    }
}
